(() => {
  ...
  const SEEDS = [
    ...
    { id: "seed_special", name: "たこぴのタネ", desc: "植えると\nたこぴだけ\n出てくる", factor: 1.0, img: "https://ul.h3z.jp/29OsEvjf.png", fx: "たこぴカード13種" },
    { id: "seed_bussasari", name: "ブッ刺さりタネ", desc: "ダーツプロ\n8種だけが\n出てくる", factor: 1.05, img: "https://ul.h3z.jp/MjWkTaU3.png", fx: "ダーツプロ全8種" },
    { id: "seed_namara_kawasar", name: "なまら買わさるタネ", desc: "限定カード\nだけ狙える\n特別タネ", factor: 1.08, img: "https://ul.h3z.jp/yiqHzfi0.png", fx: "限定ｼｮｯﾌﾟｶｰﾄﾞ全22種" },
